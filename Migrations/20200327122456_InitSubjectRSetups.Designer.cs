...
namespace tuexamapi.Migrations
{
    ...
    [Migration("20200327122456_InitSubjectRSetups")]
    partial class InitSubjectRSetups
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("tuexamapi.Models.SubjectRSetup", b =>
                {
                    ...
                    b.Property<int>("SubjectSub1ID")
                        .HasColumnType("int");

                    b.Property<int>("SubjectSub2ID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SubjectSub1ID");

                    b.HasIndex("SubjectSub2ID");

                    b.HasIndex("SubjectSubfromPart1ID");
            ...
            modelBuilder.Entity("tuexamapi.Models.SubjectRSetup", b =>
                {
                    b.HasOne("tuexamapi.Models.SubjectSub", "SubjectSub1")
                        .WithMany()
                        .HasForeignKey("SubjectSub1ID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("tuexamapi.Models.SubjectSub", "SubjectSub2")
                        .WithMany()
                        .HasForeignKey("SubjectSub2ID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("tuexamapi.Models.SubjectSub", "SubjectSubfromPart1")
                        .WithMany()
                        .HasForeignKey("SubjectSubfromPart1ID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
